...
"88cc5f47c1a28afbfb8ad16161583f5a", url="https://d6c89f97-cf91-48b7-b14b-c99b2fe27c2fbluemix.cloudantnosqldb.appdomain.cloud")
clientdb.connect()
#Create resource
...
def myCommandCallback(cmd):
 ...
 if(commamd=="lighton"):
  ...
  print('motoroff')
 myConfig = {"identity": {"orgId": "chytun","typeId": "NodeMCU","deviceId": "12345"},"auth": {"token": "12345678"}}
...
#model ID.
  request = service_pb2.PostModeloutputsRequest(model_id='e9359dbe6ee44dbc8842ebe97247b201',inputs=[resources_pb2.Input(data=resources_pb2.Data(image=resources_pb2.Image(base64=file_byte)))])
 ...
 #print(concept.name)
    ...
    if new_document.exists():
      ...
      myData={'moisture':moist,'humidity':humidity}
      print(myData)
    if(humidity!=None):
